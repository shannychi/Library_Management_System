      ...
      <div className="bg-white dark:bg-gray-800 h-screen overflow-hidden flex items-center justify-center">
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="bg-white px-10 py-8 rounded-xl w-screen  shadow-large max-w-sm">
                ...
                <button onSubmit={handleFormSubmit} type="submit"  id="login" className="mt-6 w-full shadow-xl bg-gradient-to-tr from-cyan-600 to-red-700 hover:to-red-500 text-indigo-100 py-2 rounded-md text-lg tracking-wide transition duration-1000">Login</button>
                <hr/>
                <div className="flex justify-center items-center mt-4">
                    <p className="inline-flex items-center text-gray-700 font-medium text-xs text-center">
                        <span className="ml-2">You don't have an account?<a href="/signup" className="text-xs ml-2 text-cyan-500 font-semibold">Register now &rarr;</a>
                        </span>
                    </p>
                </div>
            </div>
