          ...
          {borrowedBooks.map((borrowedBook, index) => (
            <li key={index} className="mb-4 border p-4 rounded-md shadow-sm">
              ...
              >
               ...
               <img className="object-cover w-full h-full" src={`https://library-management-system-2ku8.onrender.com${borrowedBook.bookId.cover_image}`} alt="Product"/>
                  </div>
